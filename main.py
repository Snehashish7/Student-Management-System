...
class MainWindow(QMainWindow):
    ...
    def __init__(self):  # overriding the super class __init__
        """
        ...
        status bar.
        """
        super().__init__()  # initializing the super class - QMainWindow
        ...
        # Detect a cell click and perform necessary action (edit, delete, append)
    ...
    def cell_clicked(self):
        ...
        # if there is pre-existing edit and delete button in status bar then delete them
...
class InsertDialog(QDialog):
    ...
    def __init__(self):
        ...
        courses = ["Engineering Math", "Discrete Math", "Data Structures", "Design & Analysis of Algorithm",
                   "Operating Systems", "DBMS", "Python", "Machine Learning", "Neural Networks and Deep Learning",
                   "COA", "DLD", "C-Programming", "Aptitude", "Cloud Computing", "Project-I", "Project-II"]
...
class EditDialog(QDialog):
    ...
    def __init__(self):
        ...
        # index of the row in which a cell is clicked.
        index = main_window.table.currentRow()
        # Get id from selected row
        # 'item(index, 0)':item at index-th row and 0th col(i.e the id)
        self.student_id = main_window.table.item(index, 0).text()

        # 'item(index, 1)':item at index-th row and 1st col(i.e the name)
    ...
    def update_student(self):
        """Update the student data in the database with the new data"""
        name = self.student_name.text()
        course = self.course_name.itemText(self.course_name.currentIndex())
        mobile = self.mobile.text()
